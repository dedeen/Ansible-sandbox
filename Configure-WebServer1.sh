...
#eniid=$(aws ec2 create-network-interface --description "Temp public IP to configure web server" --subnet-id ${subnetid} --query NetworkInterfaces[*].NetworkInterfaceId --output text)
